...
// Pure tuning data lives in tuning.js (a leaf module with no browser-global
// dependencies, importable from node --test). Re-exported here so existing
// importers of config.js keep working unchanged.
export { MAIN_SCENE_TUNING, pulsePatternPool, sectionPatternMap } from './tuning.js';
